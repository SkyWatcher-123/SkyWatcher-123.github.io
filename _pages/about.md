...
title: About
permalink: /
subtitle: Ph.D. Candidate in Computational Design, Carnegie Mellon University
...
social: true # includes social icons from _data/socials.yml

announcements:
  enabled: false # set to true later if you want a news/updates section
  scrollable: true
  limit: 5

latest_posts:
  enabled: false # keep false if you removed the blog tab
  scrollable: true
  limit: 3
---
...
<p style="margin-top: 1.5rem;">
  <img src="{{ '/assets/img/signature.jpg' | relative_url }}" alt="Jiaying Wei signature" style="max-width: 600px;">
</p>
